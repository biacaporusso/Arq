.data
	entrada: .asciiz "Insira um número natural N com pelo menos 10 dígitos: "
	string: .space 999
	msg_naoPalindromo: .asciiz "O número inserido não é palíndromo."
	msg_ePalindromo: .asciiz "O numero inserido é palíndromo!"
	msg_erro: .asciiz "O número não tem pelo menos 10 dígitos! Insira novamente.\n"
...
return:
	blt $s1, 10, erro	# se tamString < 10, erro
	jr $ra
...
# condições para ser palíndromo: quantidade par de dígitos e numeros opostos iguais
